...
torchrun --nproc_per_node=4 --nnodes=1 --master_port=29522 -m hidden_context.train_llm_vae_preference_model \
...
--latent_dim 1024 --hidden_dim 1024 --learning_rate 1e-05 --use_annealing True --kl_loss_weight 3e-6 --controversial_only True --fixed_contexts True \
