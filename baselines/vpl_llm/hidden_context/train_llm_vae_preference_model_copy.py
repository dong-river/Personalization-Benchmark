...
class RewardDataCollatorWithPadding:
    ...
    def __call__(self, features: List[Dict[str, Any]]) -> Dict[str, Any]:
        if self.args.other_subsets is None:
            ...
            if self.args.other_subsets == 'ultrafeedback':
                subsets = ['8', '4', '2', '1']
...
if __name__ == "__main__":
    ...
    # output_name = "/home/yd358/rds/rds-semioticsteam-gLFG2ebmCDI/river_cache/models/VPL_all/vae_Llama-2-7b-hf__200000_0.0001_cosine_1_3e-06_1024_4096_seed0_peft_last_checkpoint"
    output_name = "/home/yd358/rds/rds-semioticsteam-gLFG2ebmCDI/river_cache/models/all/vae_Llama-2-7b-hf__200000_3e-05_cosine_1_3e-06_1024_4096_seed0_peft_last_checkpoint"
    if os.path.exists(output_name):
        vae_model = VAEModel.load_model(output_name, tokenizer)
